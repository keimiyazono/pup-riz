  ...
  return (
    <React.Fragment>
      <div>
        ...
        <h2 className="text-2xl font-bold text-center mb-4 cursor-pointer">
          Student
        </h2>
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="text-center mt-6">
          <button
            type="submit"
            className="py-3 w-64 text-xl text-white bg-red-800 rounded-2xl hover:bg-red-300 active:bg-red-500 outline-none"
          >
            Sign In
          </button>
